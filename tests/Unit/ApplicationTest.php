...
class ApplicationTest extends TestCase
{
    ...
    /**
     * test tag_on_post table has recode with tag_name = newcard , postId = 1
     */
    public function testTagOnPostTableHasTagNameEqualNewCardPostIdEqual1()
    {
    	$this->assertDatabaseHas('tag_on_post', ['tag_name' => 'newcar','post_id'=> 1]);
    }
}
